...
export const Login = () => {
    ...
    const handleLogin = async(e) => {
        ...
        try{
            ...
            setError("Failed to log in, email or password are incorrect.");
        }
    }
        ...
        <div className="container-fluid py-5">
            ...
            <form onSubmit={handleLogin}>
                <div className="mb-3 row">
                    ...
                    <div className="col-sm-10">
                        {/* Cambié la clase de form-control-plaintext a form-control y el tipo de entrada a email */}
                        <input type="email" className="form-control" id="inputEmail" onChange={(e) => setEmail(e.target.value)}></input>
                    </div>
                </div>
                <div className="mb-3 row">
                    <label htmlFor="inputPassword" className="col-sm-2 col-form-label">Password</label>
